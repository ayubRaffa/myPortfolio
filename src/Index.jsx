    ...
    <>
      ...
      <section className="snapTogoalsection  relative min-h-screen   w-full">
        <div className=" flex justify-center items-center flex-col ">
          <h1 className="whitespace-pre  relative font-header text-[4.5rem] md:text-[calc(4.5rem+3vw)]  text-transparent  stroke-blue-1  text-center">
            my objective
            <h1 className="whitespace-pre absolute top-0 left-0 right-0 bottom-0 font-header text-[4.5rem] md:text-[calc(4.5rem+3vw)]  text-transparent stroke-blue-1 blur-lg ">
              my objective
            </h1>
          </h1>
      ...
      <section className="aaaa  relative min-h-screen bg-no-repeat bg-cover flex items-center justify-center">
        ...
        <div className=" relative  px-[calc(1rem+5vw)] max-w-[1000Px] my-24 ">
          <div className='z-10 mix-blend-darken -translate-x-6 rotate-[38deg] absolute top-0 bottom-0 left-0 right-0 bg-[#164d8a]' />
        ...
        <div className="">
          <div className="mx-2 border  rounded-2xl py-10 px-[calc(1rem+5vw)] max-w-[1000Px] flex flex-col gap-6 items-center">
            ...
            <p className='  text-2xl text-blue-100 text-left  '>
              with an emphasis on "incremental improvement", i look for creative ways to push the limits of website front-end code without compromising on browser support and performance,
            </p>
          </div>
        </div>
