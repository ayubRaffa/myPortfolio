...
const Index = ({ CanLoadMainContent }) => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen snapToskillssection h-fit ">
        <div className="flex justify-center ">
          <video ref={iconsAnimationRef} muted playsInline className='translate-y-11 mix-blend-lighten '  >
        ...
        <div className=" px-[calc(1rem+5vw)] flex flex-col justify-center items-center ">
          <p className='skillsh1 opacity-0 translate-y-0 text-sm max-w-[16rem] text-center'>this is some of what i learned so far </p>
