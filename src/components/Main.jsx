...
const Main = ({ CanLoadMainContent }) => {
  ...
  return (
    <>
      <main className="Main mt-2 opacity-0 scale-125 relative min-h-screen  bg-[url('../src/assets/mainbg2.png')]  bg-[color:var(--color-bg)] bg-blend- bg-no-repeat bg-cover z-40 " >
        {/* blured background */}
        <div className=" absolute rotate-180 lg:rotate-0 bottom-0 lg:top-0 right-0 w-full h-full md:h-2/3  lg:w-1/2 lg:h-[50rem] bg-[url('../src/assets/pexels6.jpg')] md:bg-contain bg-cover   bg-no-repeat  bg-[color:var(--color-bg)] bg-blend-lighten -z-20" />
