...
const Info = () => {
    return (
        ...
        <section section className="relative flex justify-center items-stretch min-h-[500px] gap-3 md:gap-6 lg:gap-10 px-1 lg:px-6 py-20 pb-40 gradient_layer  bg-hero-cutout-pink-100 z-10 " > {/* rounded-tl-[100px] rounded-tr-[100px] */}
            ...
            <div className="basis-0 flex-[1]">
                <div className=" relative flex flex-col gap-3 justify-start max-w-sm">
                    <h3 className='text-xl uppercase'>ayoub raffiai idrissi <span>28</span></h3>
                    <h4 className='font-extrabold'>Private higher education training in Multimedia Development </h4>
                    <div className="lang">
                        <div className="grid grid-cols-2 gap-1">
                            <h3>french</h3>
                            <h3> <FaStar /><FaStar /></h3>
                            <h3>english</h3>
                            <h3> <FaStar /><FaStar /><FaStar /><FaStar /></h3>
                        </div>
                    </div>
                </div>
            </div>
